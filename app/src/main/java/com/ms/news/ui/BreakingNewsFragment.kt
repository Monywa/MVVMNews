...
class BreakingNewsFragment : Fragment() {
            ...
            when (response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        if(isLastPage){
                            //remove recycler view padding bottom left for progress bar
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            /*
            calcualtion to check if we scroll until the bottom of recycler view
             */

            val layoutManager = recyclerView.layoutManager as LinearLayoutManager
            val firstVisibleItemPosition = layoutManager.findFirstVisibleItemPosition()//every top view of first item of recycler
            val visibleItemCount = layoutManager.childCount
            val totalItemCount = layoutManager.itemCount

            val isNotLoadingAndNotLastPage =
                !isLoading && !isLastPage //after loading and the max page
